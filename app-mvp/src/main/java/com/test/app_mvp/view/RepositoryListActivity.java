...
import com.test.app_mvp.contract.RepositoryListContract;
import com.test.app_mvp.model.GitHubService;
import com.test.app_mvp.presenter.RepositoryListPresenter;

public class RepositoryListActivity extends AppCompatActivity implements RepositoryListContract.View, RepositoryAdapter.OnRepositoryItemClickListener{
